...
resource "azurerm_linux_virtual_machine" "IN_VM" {
  ...
  admin_ssh_key {
    ...
    public_key = file("./keys/traveltrail_server.pub")
  }
  provisioner "file" {
    ...
    connection {
      ...
      private_key = file("./keys/traveltrail_server")
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "sudo su -c 'echo \"MAILER_EMAIL_DESTINATION=${var.MAILER_EMAIL_DESTINATION}\" >> /home/${var.admin_username}/.env'",
